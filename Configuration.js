...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Estado", endpointType.estadoSensor);
  //endpoints.addEndpoint("2", "Latitud", endpointType.numberSensor, numberSensorSubType.latitude);
  //endpoints.addEndpoint("3", "Longitud", endpointType.numberSensor, numberSensorSubType.longitude);
  //endpoints.addEndpoint("4", "Identificacion", endpointType.identification);
}
