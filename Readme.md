...
# Parsing + Configuration Script – Tuercometro - Rev. A

This **Parsing + Configuration** script is designed for the **Tuercometro** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Tuercometro Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Tuercometro** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
